class GameInfo {
  ...
  CalculatePixels() {
    ...
    isGameMoved := this.GamePosLeft != x or this.GamePosTop != y or this.GameHeight != height or this.GameWidth !=
      width
    ...
    if (isGameMoved) {
      ...
      loop monCount {
        ...
        if (this.GameWindowCenterX >= mx && this.GameWindowCenterX < mx + mw && this.GameWindowCenterY >= my && this.GameWindowCenterY <
          my + mh) {
          monitor := A_Index
          break
        }
